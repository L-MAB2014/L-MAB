...
public class RoboterData {
    ...
    /**
     * Code fue einen n�chsten Checkpunkt
     */
    ...
    public static final String code_CenterParking = "CP";
    ...
    public static final int number_CheckpointsExit = 4;
    public static final int number_Parkings = 4;
    public static final int number_Puffer = 3;
}
