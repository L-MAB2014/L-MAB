...
public class ViewW extends JFrame {
    ...
    ViewW() {
        ...
        this.store_green = new JCheckBox("Gr�nes Lager", false);
        this.store_yellow = new JCheckBox("Gelbes Lager", false);

        this.grp_store.add(this.store_blue);
        this.grp_store.add(this.store_green);
        this.grp_store.add(this.store_yellow);
        ...
        this.grp_exit.add(this.exit_orange);
        this.grp_exit.add(this.exit_pink);
